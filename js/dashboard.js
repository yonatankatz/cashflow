...
$('#m_datepicker_main').datepicker('update', (d.getMonth + 1) + '-' + (d.getYear + 1900));

$('.month-box .input-group-prepend button').click(function () {
    var cd = $('#m_datepicker_main').datepicker('getDate');

    var cm = cd.getMonth() + 1;
    var cy = cd.getYear() + 1900;
    ...
    $('#m_datepicker_main').datepicker('update', nm + '-' + ny);
});

$('.month-box .input-group-append button').click(function () {
    var cd = $('#m_datepicker_main').datepicker('getDate');
...
$('#m_datepicker_3').datepicker('setDate', today);